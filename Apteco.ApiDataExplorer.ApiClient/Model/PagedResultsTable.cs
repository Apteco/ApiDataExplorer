...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsTable :  IEquatable<PagedResultsTable>
    {
        ...
        public PagedResultsTable(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<Table> List = default(List<Table>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsTable and cannot be null");
            }
            else
            {
                this.List = List;
