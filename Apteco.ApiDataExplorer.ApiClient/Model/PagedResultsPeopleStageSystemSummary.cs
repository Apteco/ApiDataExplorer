...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsPeopleStageSystemSummary :  IEquatable<PagedResultsPeopleStageSystemSummary>
    {
        ...
        protected PagedResultsPeopleStageSystemSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsPeopleStageSystemSummary" /> class.
        /// </summary>
        ...
        public PagedResultsPeopleStageSystemSummary(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<PeopleStageSystemSummary> List = default(List<PeopleStageSystemSummary>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsPeopleStageSystemSummary and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<PeopleStageSystemSummary> List { get; set; }
