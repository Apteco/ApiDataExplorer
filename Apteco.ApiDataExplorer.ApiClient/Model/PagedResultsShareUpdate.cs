...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsShareUpdate :  IEquatable<PagedResultsShareUpdate>
    {
        ...
        protected PagedResultsShareUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsShareUpdate" /> class.
        /// </summary>
        ...
        public PagedResultsShareUpdate(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<ShareUpdate> List = default(List<ShareUpdate>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsShareUpdate and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<ShareUpdate> List { get; set; }
