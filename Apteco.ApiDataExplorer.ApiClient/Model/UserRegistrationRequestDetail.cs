...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class UserRegistrationRequestDetail :  IEquatable<UserRegistrationRequestDetail>
    {
        ...
        protected UserRegistrationRequestDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRegistrationRequestDetail" /> class.
        /// </summary>
        ...
        public UserRegistrationRequestDetail(string ConfirmRegistrationUrl = default(string), bool? HasNotificationBeenSent = default(bool?), Guid? Token = default(Guid?), string Username = default(string), string Firstname = default(string), string Surname = default(string), string EmailAddress = default(string), DateTime? CreationDate = default(DateTime?), DateTime? ConfirmedDate = default(DateTime?), DateTime? ExpiredDate = default(DateTime?))
        {
            ...
            if (Token == null)
            {
                throw new InvalidDataException("Token is a required property for UserRegistrationRequestDetail and cannot be null");
            }
            else
            {
                this.Token = Token;
