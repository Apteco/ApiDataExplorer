...
{
    /// <summary>
    /// Summary for a list update
    /// </summary>
    [DataContract]
    public partial class ListUpdateSummary :  IEquatable<ListUpdateSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUpdateSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUpdateSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUpdateSummary" /> class.
        /// </summary>
        ...
        public ListUpdateSummary(int? Id = default(int?), DateTime? Timestamp = default(DateTime?), UserDisplayDetails User = default(UserDisplayDetails), string Title = default(string), string Description = default(string), UserDisplayDetails Owner = default(UserDisplayDetails), bool? IsDeleted = default(bool?), string ResolveTableName = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
            ...
            if (User == null)
            {
                throw new InvalidDataException("User is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
                this.User = User;
            ...
            if (Title == null)
            {
                throw new InvalidDataException("Title is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
                this.Title = Title;
            ...
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
            ...
            if (Owner == null)
            {
                throw new InvalidDataException("Owner is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
                this.Owner = Owner;
            ...
            if (IsDeleted == null)
            {
                throw new InvalidDataException("IsDeleted is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ResolveTableName is a required property for ListUpdateSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUpdateSummary {\n");
        ...
        {
            return this.Equals(input as ListUpdateSummary);
        }

        /// <summary>
        /// Returns true if ListUpdateSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUpdateSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUpdateSummary input)
        {
            if (input == null)
                return false;
