...
{
    /// <summary>
    /// Details for a job to count a list
    /// </summary>
    [DataContract]
    public partial class ListCalculateJobDetail :  IEquatable<ListCalculateJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCalculateJobDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListCalculateJobDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCalculateJobDetail" /> class.
        /// </summary>
        ...
        [DataMember(Name="listResult", EmitDefaultValue=false)]
        public ListResultDetail ListResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListCalculateJobDetail {\n");
            sb.Append("  ListResult: ").Append(ListResult).Append("\n");
        ...
        {
            return this.Equals(input as ListCalculateJobDetail);
        }

        /// <summary>
        /// Returns true if ListCalculateJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ListCalculateJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListCalculateJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ListResult == input.ListResult ||
                    (this.ListResult != null &&
                    this.ListResult.Equals(input.ListResult))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ListResult != null)
                    hashCode = hashCode * 59 + this.ListResult.GetHashCode();
                if (this.Id != null)
