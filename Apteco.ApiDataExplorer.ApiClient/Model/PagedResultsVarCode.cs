...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsVarCode :  IEquatable<PagedResultsVarCode>
    {
        ...
        public PagedResultsVarCode(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<VarCode> List = default(List<VarCode>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsVarCode and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<VarCode> List { get; set; }
