...
{
    /// <summary>
    /// Details for registering a list hit
    /// </summary>
    [DataContract]
    public partial class CreateListHitDetails :  IEquatable<CreateListHitDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateListHitDetails" /> class.
        /// </summary>
        /// <param name="UserAgentDetails">Details of the client application that made the view.</param>
        public CreateListHitDetails(string UserAgentDetails = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateListHitDetails {\n");
        ...
        {
            return this.Equals(input as CreateListHitDetails);
        }

        /// <summary>
        /// Returns true if CreateListHitDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateListHitDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateListHitDetails input)
        {
            if (input == null)
                return false;
