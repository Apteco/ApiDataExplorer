...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class FileStream :  IEquatable<FileStream>
    {
        ...
        public FileStream(Object Handle = default(Object), SafeFileHandle SafeFileHandle = default(SafeFileHandle), long? Position = default(long?), int? ReadTimeout = default(int?), int? WriteTimeout = default(int?))
        {
            this.Handle = Handle;
