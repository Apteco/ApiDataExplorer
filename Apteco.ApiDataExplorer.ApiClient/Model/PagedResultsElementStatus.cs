...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsElementStatus :  IEquatable<PagedResultsElementStatus>
    {
        ...
        protected PagedResultsElementStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsElementStatus" /> class.
        /// </summary>
        ...
        public PagedResultsElementStatus(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<ElementStatus> List = default(List<ElementStatus>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsElementStatus and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<ElementStatus> List { get; set; }
