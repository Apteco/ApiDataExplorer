...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsVariable :  IEquatable<PagedResultsVariable>
    {
        ...
        protected PagedResultsVariable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsVariable" /> class.
        /// </summary>
        ...
        public PagedResultsVariable(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<Variable> List = default(List<Variable>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsVariable and cannot be null");
            }
            else
            {
                this.List = List;
