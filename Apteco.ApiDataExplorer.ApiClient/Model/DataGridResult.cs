...
{
    /// <summary>
    /// Details for a DataGrid
    /// </summary>
    [DataContract]
    public partial class DataGridResult :  IEquatable<DataGridResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataGridResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataGridResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataGridResult" /> class.
        /// </summary>
        /// <param name="Title">The title of the DataGrid.</param>
        /// <param name="Notes">Any notes associated with the DataGrid.</param>
        /// <param name="RanSuccessfully">Whether the DataGrid was returned successfully or not (required).</param>
        /// <param name="SystemName">The name of the FastStats system that this DataGrid has been produced by.</param>
        /// <param name="SystemLoadDate">The date and time that the FastStats system was last built.</param>
        /// <param name="UserName">The name of the user that requested this DataGrid.</param>
        /// <param name="RunDate">The date and time that this DataGrid was run on.</param>
        ...
        /// <param name="Headers">The DataGrid Headers.</param>
        /// <param name="Rows">The data values in the DataGrid formated as a list of lists.</param>
        public DataGridResult(string Title = default(string), string Notes = default(string), bool? RanSuccessfully = default(bool?), string SystemName = default(string), DateTime? SystemLoadDate = default(DateTime?), string UserName = default(string), DateTime? RunDate = default(DateTime?), string QueryDescription = default(string), List<Count> Counts = default(List<Count>), List<DataGridHeader> Headers = default(List<DataGridHeader>), List<List<string>> Rows = default(List<List<string>>))
        {
            // to ensure "RanSuccessfully" is required (not null)
            if (RanSuccessfully == null)
            {
                throw new InvalidDataException("RanSuccessfully is a required property for DataGridResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The title of the DataGrid</value>
        [DataMember(Name="title", EmitDefaultValue=false)]
        public string Title { get; set; }

        /// <summary>
        /// Any notes associated with the DataGrid
        /// </summary>
        /// <value>Any notes associated with the DataGrid</value>
        [DataMember(Name="notes", EmitDefaultValue=false)]
        public string Notes { get; set; }

        /// <summary>
        /// Whether the DataGrid was returned successfully or not
        /// </summary>
        /// <value>Whether the DataGrid was returned successfully or not</value>
        [DataMember(Name="ranSuccessfully", EmitDefaultValue=false)]
        public bool? RanSuccessfully { get; set; }

        /// <summary>
        /// The name of the FastStats system that this DataGrid has been produced by
        /// </summary>
        /// <value>The name of the FastStats system that this DataGrid has been produced by</value>
        [DataMember(Name="systemName", EmitDefaultValue=false)]
        public string SystemName { get; set; }

        /// <summary>
        /// The date and time that the FastStats system was last built
        /// </summary>
        /// <value>The date and time that the FastStats system was last built</value>
        [DataMember(Name="systemLoadDate", EmitDefaultValue=false)]
        public DateTime? SystemLoadDate { get; set; }

        /// <summary>
        /// The name of the user that requested this DataGrid
        /// </summary>
        /// <value>The name of the user that requested this DataGrid</value>
        [DataMember(Name="userName", EmitDefaultValue=false)]
        public string UserName { get; set; }

        /// <summary>
        /// The date and time that this DataGrid was run on
        /// </summary>
        /// <value>The date and time that this DataGrid was run on</value>
        ...
        /// <summary>
        /// The DataGrid Headers
        /// </summary>
        /// <value>The DataGrid Headers</value>
        [DataMember(Name="headers", EmitDefaultValue=false)]
        public List<DataGridHeader> Headers { get; set; }

        /// <summary>
        /// The data values in the DataGrid formated as a list of lists
        /// </summary>
        /// <value>The data values in the DataGrid formated as a list of lists</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataGridResult {\n");
        ...
        {
            return this.Equals(input as DataGridResult);
        }

        /// <summary>
        /// Returns true if DataGridResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DataGridResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataGridResult input)
        {
            if (input == null)
                return false;
