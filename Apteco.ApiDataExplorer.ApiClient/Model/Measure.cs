...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class Measure :  IEquatable<Measure>
    {
        ...
        /// <summary>
        /// If the measure is based on a query - the definition of the query to use
        /// </summary>
        /// <value>If the measure is based on a query - the definition of the query to use</value>
        [DataMember(Name="query", EmitDefaultValue=false)]
        public Query Query { get; set; }

        /// <summary>
        /// A query used to filter the records for each cell in this measure
        /// </summary>
        /// <value>A query used to filter the records for each cell in this measure</value>
        [DataMember(Name="filterQuery", EmitDefaultValue=false)]
        public Query FilterQuery { get; set; }

        /// <summary>
        /// If the measure is based on an expression then the expression to use
        /// </summary>
        /// <value>If the measure is based on an expression then the expression to use</value>
