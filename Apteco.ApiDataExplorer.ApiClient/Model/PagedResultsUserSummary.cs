...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsUserSummary :  IEquatable<PagedResultsUserSummary>
    {
        ...
        protected PagedResultsUserSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsUserSummary" /> class.
        /// </summary>
        ...
        public PagedResultsUserSummary(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<UserSummary> List = default(List<UserSummary>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsUserSummary and cannot be null");
            }
            else
            {
                this.List = List;
