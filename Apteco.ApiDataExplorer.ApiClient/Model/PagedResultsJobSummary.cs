...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsJobSummary :  IEquatable<PagedResultsJobSummary>
    {
        ...
        protected PagedResultsJobSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsJobSummary" /> class.
        /// </summary>
        ...
        public PagedResultsJobSummary(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<JobSummary> List = default(List<JobSummary>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsJobSummary and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<JobSummary> List { get; set; }
