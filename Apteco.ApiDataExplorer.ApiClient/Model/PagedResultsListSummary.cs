...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResultsListSummary :  IEquatable<PagedResultsListSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsListSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResultsListSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsListSummary" /> class.
        /// </summary>
        ...
        public PagedResultsListSummary(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<ListSummary> List = default(List<ListSummary>))
        {
            // to ensure "Offset" is required (not null)
            if (Offset == null)
            {
                throw new InvalidDataException("Offset is a required property for PagedResultsListSummary and cannot be null");
            }
            else
            {
                this.Offset = Offset;
            ...
            if (Count == null)
            {
                throw new InvalidDataException("Count is a required property for PagedResultsListSummary and cannot be null");
            }
            else
            {
                this.Count = Count;
            ...
            if (TotalCount == null)
            {
                throw new InvalidDataException("TotalCount is a required property for PagedResultsListSummary and cannot be null");
            }
            else
            {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsListSummary and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<ListSummary> List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsListSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsListSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsListSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsListSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsListSummary input)
        {
            if (input == null)
                return false;
