...
namespace Apteco.ApiDataExplorer.ApiClient.Model
{
    ...
    public partial class PagedResultsShareSummary :  IEquatable<PagedResultsShareSummary>
    {
        ...
        protected PagedResultsShareSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsShareSummary" /> class.
        /// </summary>
        ...
        public PagedResultsShareSummary(int? Offset = default(int?), int? Count = default(int?), int? TotalCount = default(int?), List<ShareSummary> List = default(List<ShareSummary>))
        {
            ...
            if (List == null)
            {
                throw new InvalidDataException("List is a required property for PagedResultsShareSummary and cannot be null");
            }
            else
            {
                this.List = List;
        ...
        public List<ShareSummary> List { get; set; }
